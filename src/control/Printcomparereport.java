 ...
 * @author Gihan
 */
public class Printcomparereport implements Printable {
...
//Company Name, Address & SlipHeading Details****************************************************************************        
        ...
        CentrePrint("Monthly Comparison Report ", WIDTH, -40, VariTopMargin += LINEHEIGHT + 2, g);
        ...
        System.out.println("Total1: " + formatForDouble(getTotal1()));
        System.out.println("Total2: " + formatForDouble(getTotal2()));
        System.out.println("Compare: " + formatForDouble(getCompamount()));
        
        g.drawString("Total Amount for: " + getMonth(getMonth1()) + "-" + getYear1(), LEFTMARGIN+10, VariTopMargin += LINEHEIGHT);
        g.drawString(formatForDouble(getTotal1()), 200, VariTopMargin);
        g.drawString("Total Amount for: " + getMonth(getMonth2()) + "-" + getYear2(), LEFTMARGIN+10, VariTopMargin += LINEHEIGHT);
        g.drawString(formatForDouble(getTotal2()), 200, VariTopMargin);
        g.drawString("Comparison: ", LEFTMARGIN+10, VariTopMargin += LINEHEIGHT);
        g.drawString(formatForDouble(getCompamount()), 200, VariTopMargin);
