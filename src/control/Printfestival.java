 ...
 * @author Gihan
 */
public class Printfestival implements Printable {
...
//Company Name, Address & SlipHeading Details****************************************************************************        
        ...
        CentrePrint("Festival Advance Deduction Report - " + getMonth(getMonth()) + " " + getYear(), WIDTH, -40, VariTopMargin += LINEHEIGHT + 2, g);
        ...
        CentrePrint("Emp.No", coloumwidth - 46, LEFTMARGIN, VariTopMargin += LINEHEIGHT, g);
        CentrePrint("Name", coloumwidth + 24, LEFTMARGIN + 40 + coloumwidth, VariTopMargin, g);
        CentrePrint("Site", coloumwidth + 22, LEFTMARGIN + 40 + (2 * coloumwidth), VariTopMargin, g);
        CentrePrint("Deduct.Amount", coloumwidth, LEFTMARGIN + 40 + (3 * coloumwidth), VariTopMargin, g);
        VariTopDidMargin = VariTopMargin;

        g.setFont(fontd2);

        for (int x = 0; x < tblprint.getRowCount(); x++) {
            ArrangedTextPrint("", tblprint.getValueAt(x, 0).toString(), coloumwidth - 70, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
            ArrangedTextPrint("", tblprint.getValueAt(x, 1).toString(), coloumwidth + 24, LEFTMARGIN + 10 + coloumwidth, VariTopMargin, g);
            ArrangedTextPrint("", tblprint.getValueAt(x, 2).toString(), coloumwidth + 22, LEFTMARGIN + 10 + (2 * coloumwidth), VariTopMargin, g);
        ...
        g.drawString("Total Festival Advance Deducted Employees: ", LEFTMARGIN, VariTopMargin + LINEHEIGHT);
        g.drawString("" + getTotrecords(), LEFTMARGIN + 250, VariTopMargin += LINEHEIGHT);
        g.drawString("Total Deducted Amount: ", LEFTMARGIN, VariTopMargin + LINEHEIGHT);
        g.drawString("" + formatForDouble(getTotamount()), LEFTMARGIN + 250, VariTopMargin + LINEHEIGHT);
        VariTopMargin += LINEHEIGHT;
        g.drawLine(LEFTMARGIN, VariTopMargin + LINEHEIGHT, AviWidth + LEFTMARGIN, VariTopMargin + LINEHEIGHT);
