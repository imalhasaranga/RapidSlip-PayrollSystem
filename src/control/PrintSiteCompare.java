 ...
 * @author Gihan
 */
public class PrintSiteCompare implements Printable {
...
//Company Name, Address & SlipHeading Details****************************************************************************        
        ...
        g.setFont(fontn);
        CentrePrint("Site Wise Compare Report", WIDTH, -40, VariTopMargin += LINEHEIGHT, g);
        CentrePrint(getMonth(getMonth()) + " " + getYear() + "(Total1) AND " + getMonth(getMonth2()) + " " + getYear2() + "(Total2)", WIDTH, -40, VariTopMargin += LINEHEIGHT, g);
...
//        CentrePrint("SALARY TOTAL", coloumwidth, LEFTMARGIN + 100, VariTopMargin, g);
        ...
        g.drawString("Total1", 120, VariTopMargin);
        g.drawString("Total2", 200, VariTopMargin);
        g.drawString("Comparison", 280, VariTopMargin);
