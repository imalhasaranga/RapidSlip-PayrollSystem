 ...
 * @author Imal
 */
public class GrossSalaryReport implements Printable {
    ...
    public GrossSalaryReport(JTable jt,int month,int Year) {
        this.jt = jt;
        this.month = month;
        this.Year = Year;
    }
    ...
    public synchronized void printThisInvoice() {
        try {
            ...
            rs = DB.getData("SELECT Site_location FROM site where is_active='1' ");
            while (rs.next()) {
                ++page;
    ...
    public synchronized int print(Graphics g, PageFormat pf, int pageIndex) throws PrinterException {
        ...
        try {
            ...
            CentrePrint("8/16, Thalapathpitiya Road, Nugegoda.", WIDTH, -500, VariTopMargin += LINEHEIGHT + 3, g);
                    ...
                    CentrePrint("GrossSalary Report For " + getMonth(month).toUpperCase() + " " + Year, WIDTH, -500, VariTopMargin += LINEHEIGHT + 3, g);
            CentrePrint("Site : " + rs.getString("Site_location") + "  (Page: " + (page)+" )", WIDTH, -500, VariTopMargin += LINEHEIGHT + 3, g);
            ...
            String print1 = "||" + createColumnStringcen1("Emp", column - 27) + "|"
                    ...
                    + "|" + createColumnStringcen2("Addition", column - 7) + "|"
                     + "|" + createColumnStringcen2("EPF 12%", column - 7) + "|"
                     + "|" + createColumnStringcen2("ETF 3%", column - 7) + "|"
...
//                    + "|" + createColumnStringcen2("Salary", column - 7) + "||";
            ...
            for (int i = 0; i < jt.getRowCount(); i++) {
                ...
                if (rs.getString("Site_location").equals(jt.getValueAt(i, 4).toString())) {
                    ...
                    double GrossAmount = Bforpf + netAllow + Double.parseDouble(jt.getValueAt(i, 14).toString()) + Double.parseDouble(jt.getValueAt(i, 13).toString())+Double.parseDouble(jt.getValueAt(i, 8).toString())+Double.parseDouble(jt.getValueAt(i, 9).toString());
                    columnVariable = 0;
                    ...
                    epf12 += Double.parseDouble(jt.getValueAt(i, 8).toString());
                    etf3 += Double.parseDouble(jt.getValueAt(i, 9).toString());
                    ...
                    String print =
                            ...
                            + " " + getTableColumVal(i, 8, column - 7) + " "
                             + " " + getTableColumVal(i, 9, column - 7) + " "
...
//                            + " " + getTableColumVal(i, 19, column - 7) + "  ";
            ...
            String print11 =
                    ...
                    + " " + createColumnStringFormated(epf12 + "", column - 7) + " "
                    + " " + createColumnStringFormated(etf3 + "", column - 7) + " "
                    + " " + createColumnStringFormated(grossamount + "", column - 7) + " ";
...
//                    + " " + createColumnStringFormated(netSalry + "", column - 7) + "  ";
            ...
            columnVariable = 0;
            VariTopMargin += LINEHEIGHT * 1;
            g.drawLine(LEFTMARGIN, VariTopMargin + 5, 660 + LEFTMARGIN, VariTopMargin + 5);
