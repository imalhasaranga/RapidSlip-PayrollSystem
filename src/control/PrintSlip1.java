 ...
 * @author Gihan
 */
public class PrintSlip1 implements Printable {
...
//Company Name, Address & SlipHeading Details****************************************************************************        
        ...
        CentrePrint("Employee Pay slip - " + getMonth(month) + " " + year, WIDTH, -40, VariTopMargin += LINEHEIGHT, g);
...
//Sub HEading Details****************************************************************************************************
        ...
        g.drawString("Employee Name: " + empname.toUpperCase(), LEFTMARGIN, VariTopMargin += LINEHEIGHT - 5);
        g.drawString("Emp.No: "+ empno + "     EPF.No: " + epfno, LEFTMARGIN, VariTopMargin += LINEHEIGHT - 5);
        g.drawString("Site: "+(getSite()).toUpperCase(), LEFTMARGIN, VariTopMargin += LINEHEIGHT - 5);

//Deaw a line to seperate------------------------------------------------------------------------------------------------
        //VariTopMargin += LINEHEIGHT * 1;
        DrawBreakLine(LEFTMARGIN, VariTopMargin+10, g);
        g.setFont(fontd);
//        g.drawLine(LEFTMARGIN, VariTopMargin + 5, AviWidth + LEFTMARGIN, VariTopMargin + 5); //90

//Earnings & Deductions Title********************************************************************************************
        CentrePrint("EARNINGS", coloumwidth, LEFTMARGIN, VariTopMargin += LINEHEIGHT + 5, g);
...
//Earning Column Details*************************************************************************************************
        ...
        ArrangedTextPrint("Other: ", formatForDouble(grossallowance + additiontotal), coloumwidth - 10, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ArrangedTextPrint("", "---------------", coloumwidth - 10, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ...
        ArrangedTextPrint("BALANCE PAY: ", formatForDouble(getBalancepay()), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopMargin -= LINEHEIGHT, g);
        g.setFont(fontN);
        ArrangedTextPrint("PACKET PAY: ", formatForDouble(getPacketPay()), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopMargin + LINEHEIGHT, g);
        g.setFont(fontd);
...
//Deduction Column Details****************************************************************************************************        
        ArrangedTextPrint("EPF Employee: ", formatForDouble(epfemployee), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
        ArrangedTextPrint("P.A.Y.E.: ", formatForDouble(paye), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
        ArrangedTextPrint("Advance: ", formatForDouble(advancepay), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
        ArrangedTextPrint("", "---------------", coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
        ArrangedTextPrint("S.Total: ", formatForDouble(epfemployee + paye + advancepay), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
        ArrangedTextPrint("Other: ", formatForDouble(deducttotal), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
        ArrangedTextPrint("", "---------------", coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
        ArrangedTextPrint("Total: ", formatForDouble(deducttotal + epfemployee + paye + advancepay), coloumwidth - 10, LEFTMARGIN + 60 + coloumwidth, VariTopDidMargin += LINEHEIGHT, g);
...
//        g.drawLine(LEFTMARGIN, VariTopMargin, AviWidth + LEFTMARGIN, VariTopMargin);
        ...
        ArrangedTextPrint("Total EPF(20%): ", formatForDouble(epftotal), coloumwidth + 40, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT + 4, g);
        ArrangedTextPrint("Employer's Con. for EPF(12%): ", formatForDouble(epfcompany), coloumwidth + 40, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ArrangedTextPrint("Employer's Con. for ETF(3%): ", formatForDouble(etf), coloumwidth + 40, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ...
        for (Allsaldetails sal : getArray_allow()) {
            ArrangedTextPrint(sal.detailname, formatForDouble(sal.amount), coloumwidth + 40, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        }

        for (Allsaldetails sal2 : getArray_addition()) {
            ArrangedTextPrint(sal2.detailname, formatForDouble(sal2.amount), coloumwidth + 40, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
            //g.drawString("(" + sal2.description + ")", LEFTMARGIN + coloumwidth - 50, VariTopMargin);
        }

        for (Allsaldetails sal3 : getArray_deduct()) {
            ArrangedTextPrint(sal3.detailname, formatForDouble(sal3.amount), coloumwidth - 5, LEFTMARGIN + 60 + (coloumwidth), forDid += LINEHEIGHT, g);
        ...
        ArrangedTextPrint("..........................", "", AviWidth / 2, coloumwidth + 80, VariTopMargin, g);
        ArrangedTextPrint("      Employee", "", AviWidth / 2, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ArrangedTextPrint("    Administrator", "", AviWidth / 2, coloumwidth + 80, VariTopMargin, g);
        VariTopMargin += LINEHEIGHT;
