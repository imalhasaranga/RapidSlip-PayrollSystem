 ...
 * @author Imal
 */
public class SitewiseCompleteReport implements Printable {
    ...
    public SitewiseCompleteReport(JTable jt,int month,int Year) {
        this.jt = jt;
        this.month = month;
        this.Year = Year;
    }
    ...
    public synchronized int print(Graphics g, PageFormat pf, int pageIndex) throws PrinterException {
        ...
        try {
            ...
            CentrePrint("Site : " + rs.getString("Site_location") + "  (Page: " + (page)+" )", WIDTH, -250, VariTopMargin += LINEHEIGHT + 3, g);
