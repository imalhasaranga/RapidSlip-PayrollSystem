 ...
 * @author Imal
 */
public class SitewiseDesignationReport implements Printable {
    ...
    public SitewiseDesignationReport(JTable jt, int month, int Year, ArrayList<String> designation, String reportname) {
        this.jt = jt;
        this.month = month;
        this.Year = Year;
    ...
    public synchronized int print(Graphics g, PageFormat pf, int pageIndex) throws PrinterException {
        ...
        try {
            ...
            CentrePrint("Designation : " + reportname + "  (Page: " + (page) + " )", WIDTH, -250, VariTopMargin += LINEHEIGHT + 3, g);
            ...
            for(String s : designation){
                for (int i = 0; i < jt.getRowCount(); i++) {
                    ...
                    if (s.trim().equals(jt.getValueAt(i, 3).toString().trim())) {
                        ++heightcounter;
                        ...
                        if(((int)(heightcounter/50)) >0 ){
                        VariTopMargin += LINEHEIGHT * 10;
                        heightcounter =0;
                        }
                    }
                }
