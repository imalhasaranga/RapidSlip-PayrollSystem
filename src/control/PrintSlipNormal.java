 ...
 * @author Gihan
 */
public class PrintSlipNormal implements Printable {
    ...
    public synchronized int print(Graphics g, PageFormat pf, int pageIndex) throws PrinterException {
        ...
        int coloumwidth = AviWidth / 2 - AviWidth / 16;
...
//Company Name, Address & SlipHeading Details****************************************************************************        
        ...
        CentrePrint("K.D.A. Weerasinghe & Co. (Pvt) Ltd", WIDTH, 0, VariTopMargin, g);
        g.setFont(fontn);
        CentrePrint("8/16, Thalapathpitiya Road, Nugegoda", WIDTH, 0, VariTopMargin += LINEHEIGHT + 3, g);
        CentrePrint("Employee Pay slip - " + getMonth(month) + " " + year, WIDTH, 0, VariTopMargin += LINEHEIGHT + 2, g);
...
//Earning Column Details*************************************************************************************************
        ...
        g.setFont(fontN);
        ArrangedTextPrint("BALANCE PAY : ", formatForDouble(getBalancepay()), coloumwidth - 10, LEFTMARGIN + 40 + coloumwidth, VariTopMargin -= LINEHEIGHT, g);
        g.setFont(fontd);
...
//Deduction Column Details****************************************************************************************************        
        ...
        ArrangedTextPrint("Total EPF(20%): ", formatForDouble(epftotal), coloumwidth - 10, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT + 4, g);
        ArrangedTextPrint("Employer's Con. for EPF(12%): ", formatForDouble(epfcompany), coloumwidth - 10, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ArrangedTextPrint("Employer's Con. for EPF(3%): ", formatForDouble(etf), coloumwidth - 10, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ...
        for (Allsaldetails sal2 : getArray_addition()) {
            ArrangedTextPrint(sal2.detailname + " " + "(" + sal2.description + ")", formatForDouble(sal2.amount), coloumwidth - 10, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        ...
        ArrangedTextPrint("           Employee", "Administrator         ", AviWidth / 2, LEFTMARGIN + 10, VariTopMargin += LINEHEIGHT, g);
        VariTopMargin += LINEHEIGHT;
        g.drawLine(LEFTMARGIN, VariTopMargin, AviWidth + LEFTMARGIN, VariTopMargin);
        return PAGE_EXISTS;
